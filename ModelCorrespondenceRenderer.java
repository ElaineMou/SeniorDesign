...
public class ModelCorrespondenceRenderer extends Renderer {
    ...
    protected void initScene() {
        ...
        vertexShader.useVertexColors(true);
        mHouseMaterial = new Material(vertexShader, new FragmentShader());
        //mHouseMaterial = new Material();
        List<ALight> lights = new ArrayList<ALight>();
        lights.add(light);
        lights.add(light2);
        mHouseMaterial.enableLighting(true);
        mHouseMaterial.setLights(lights);
        mHouseMaterial.useVertexColors(true);
        ...
        mHouseMaterial.setColorInfluence(1.0f);

        // Load STL model.
        LoaderPly parser = new LoaderPly(getContext().getResources(), mTextureManager,
                R.raw.legowall);
        ...
        try {
            ...
            Log.d("PLYPARSER",mHouseObject3D.getGeometry().getColorBufferInfo().toString());
